...
struct StudentInformation {
    ...
    //this initializer takes a dictionary and uses its keys and values to initialize each struct instance; the elements of each incoming dictionary are generated by the generatePostsFromData method on the StudentPosts class (which converts the raw NSDictionary post data from parse to the [String: AnyObject] dictionaries used here)
